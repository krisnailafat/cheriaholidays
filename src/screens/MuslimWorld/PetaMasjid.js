...
class PetaMasjid extends Component {
    ...
    aktifPeta = () => {
        LocationServicesDialogBox.checkLocationServicesIsEnabled({
            ...
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                //     'Coba kembali',
                //     [
                //         { text: 'OK', onPress: () => this.aktifPeta() },
                //     ],
                //     // { cancelable: false }
                // )
                console.log(error)
    ...
    _listEmptyComponent = () => {
        ...
        return (
            <TextNormal style={{ width: '100%', color: '#757575', fontSize: 14, textAlign: 'center', marginTop: 40 }}>Tidak ditemukan Masjid</TextNormal>
        )
    }
    ...
    renderPeta() {
        ...
        if (
            ...
            return (
                // <View style={{ borderWidth: 1, borderRadius: 5, backgroundColor: 'white', padding: 5, marginBottom: 5, alignItems: 'center', marginHorizontal: 5 }}>
                // <View style={{ paddingHorizontal: 19 }}>
                <View style={{ width: deviceWidth, backgroundColor: '#ffffff', paddingHorizontal: 19 }}>
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#f6f6f6', }}>
                ...
                <View style={{ width: deviceWidth, paddingHorizontal: 16, marginTop: 12, marginBottom: 10 }}>
                    <View style={{ width: '100%', borderWidth: 0.1, borderRadius: 5, flexDirection: 'row', backgroundColor: '#ffffff' }}>
                        <View style={{ width: 73, height: 73, margin: 6, borderWidth: 0 }}>
                            <ProgressiveImage resizeMode="contain" thumbnailSource={require('../../assets/masjid.png')} source={require('../../assets/masjid.png')} style={{ width: '100%', height: '100%', }} imageStyle={{}} />
                        </View>
                        <View style={{ justifyContent: 'center', borderWidth: 0, width: '65%', paddingLeft: 15, margin: 6 }}>
                            <TextSemiBold style={{ color: "#2BB04C", fontSize: 20, marginBottom: 8 }}>Masjid Terdekat</TextSemiBold>
                            <TextNormal style={{ color: "#757575", fontSize: 14 }}>Petunjuk masjid terdekat</TextNormal>
                        </View>
                    </View>
                </View>
                ...
                {/* <View style={{ alignItems: 'center', borderWidth: 0, flex: 0, flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#f6f6f6' }}> */}
                {/* <View style={{ width: deviceWidth, backgroundColor: '#ffffff' }}>
                    <TextSemiBold style={{ color: '#757575', fontSize: 12, width: '100%', paddingLeft: 16, marginBottom: 5, marginTop: 13 }}>Near you</TextSemiBold> */}
                {this.renderPeta()}
                {/* </View> */}
            </View >
        )
...
export default connect(null, null)(PetaMasjid);