...
class Adhan extends Component {
    ...
    getLocation() {
        navigator.geolocation.getCurrentPosition((position) => {
            ...
            const fetch_url = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=' + position.coords.latitude + ',' + position.coords.longitude + '&key=AIzaSyD20cuaN2i3qXq_vq7EwD8mhrayjCAA_-w';
                ...
                .then((response) => {
                    ...
                    for (var i = 0; i < results.length; i++) {
                        if (results[i].types[0] === "locality") {
                            ...
                            console.log((results[i].address_components[0].short_name).toLowerCase())
...
export default connect(null, null)(Adhan);