    ...
    return (
        <View style={{ paddingHorizontal: 10, paddingVertical: 5 }}>
            <TouchableOpacity onPress={props.onItemPressed} activeOpacity={0.8}>
                <View style={{ height: 80, width: 60, alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={[{ height: 51, width: 51, alignItems: 'center', justifyContent: 'center', borderRadius: 51 }, styles.shadow]}>
                        <ImageBackground source={{ uri: props.tourImage }} imageStyle={{ resizeMode: 'cover', borderRadius: 51 }} style={styles.placeImage} >
